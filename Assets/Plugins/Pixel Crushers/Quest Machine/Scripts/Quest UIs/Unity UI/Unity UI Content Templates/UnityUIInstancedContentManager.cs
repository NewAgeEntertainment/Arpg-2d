...
namespace PixelCrushers.QuestMachine
{
    ...
    public class UnityUIInstancedContentManager
    {
        ...
        {
            var existingInstance = retiredInstances.Find(x =>
                x.originalPrefab == template &&
                x is UnityUITextTemplate textTemplateInstance &&
                textTemplateInstance.Matches(text));
            ...
            else
            {
                ...
                newTextInstance.originalPrefab = template;
